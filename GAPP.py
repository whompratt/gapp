...
def collection(username, password, weather, temp):
...
def calculate(*args):
	try:
		...
		setup = collection(username, password, weather, session)
		if(setup[0] != 0):
			warningLabel.set("")
			frontWing.set(str(setup[0]))
			rearWing.set(str(setup[1]))
...
entryUsername = ttk.Entry(mainframe, width = 30, textvariable = inputUsername)
entryUsername.grid(column = 2, row = 1, sticky = (W, E))

entryPassword = ttk.Entry(mainframe, width = 30, show = "*", textvariable = inputPassword)
entryPassword.grid(column = 2, row = 2, sticky = (W, E))

radioQ1 = ttk.Radiobutton(mainframe, text = "Q1", variable = inputSession, value = "Q1").grid(column = 2, row = 3, sticky = (W, E))
radioQ2 = ttk.Radiobutton(mainframe, text = "Q2", variable = inputSession, value = "Q2").grid(column = 2, row = 4, sticky = (W, E))
radioRace = ttk.Radiobutton(mainframe, text = "Race", variable = inputSession, value = "Race").grid(column = 2, row = 5, sticky = (W, E))

radioDry = ttk.Radiobutton(mainframe, text = "Dry", variable = inputWeather, value = "Dry")
radioDry.grid(column = 2, row = 6, sticky = (W, E))
radioWet = ttk.Radiobutton(mainframe, text = "Wet", variable = inputWeather, value = "Wet")
...
ttk.Label(mainframe, text = "Session: ").grid(column = 1, row = 3, sticky = (W, E))
ttk.Label(mainframe, text = "Weather: ").grid(column = 1, row = 6, sticky = (W, E))


# Add a button to calculate the setup
ttk.Button(mainframe, text = "Calculate", command = calculate).grid(column = 1, row = 8)
ttk.Label(mainframe, textvariable = warningLabel).grid(column = 2, row = 8)



# OUTPUT
ttk.Label(mainframe, text = "Front Wing: ").grid(column = 1, row = 9, sticky = (W, E))
ttk.Label(mainframe, text = "Rear Wing: ").grid(column = 1, row = 10, sticky = (W, E))
ttk.Label(mainframe, text = "Engine: ").grid(column = 1, row = 11, sticky = (W, E))
ttk.Label(mainframe, text = "Brakes: ").grid(column = 1, row = 12, sticky = (W, E))
ttk.Label(mainframe, text = "Gear: ").grid(column = 1, row = 13, sticky = (W, E))
ttk.Label(mainframe, text = "Suspension: ").grid(column = 1, row = 14, sticky = (W, E))

ttk.Label(mainframe, textvariable = frontWing).grid(column = 2, row = 9)
ttk.Label(mainframe, textvariable = rearWing).grid(column = 2, row = 10)
ttk.Label(mainframe, textvariable = engine).grid(column = 2, row = 11)
ttk.Label(mainframe, textvariable = brakes).grid(column = 2, row = 12)
ttk.Label(mainframe, textvariable = gear).grid(column = 2, row = 13)
ttk.Label(mainframe, textvariable = suspension).grid(column = 2, row = 14)
